            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="mb-3">
                      ...
                      <input type="text" name="room-no" class="form-control shadow-none" required>
                  </div>
              ...
              <div class="modal-footer">
                <button type="reset" class="btn btn-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
                <button type="submit" class="btn btn custom-bg text-white shadow-none">ASSIGN</button>
              </div>
            </div>
          </form>
        </div>
