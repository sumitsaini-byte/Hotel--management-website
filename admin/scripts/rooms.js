...
function add_room()
{
  ...
  data.append('childern',add_room_form.elements['childern'].value);
...
function edit_details(id)
{
  ...
  xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    ...
    edit_room_form.elements['childern'].value = data.roomdata.childern;
...
function submit_edit_room()
{
  ...
  data.append('childern',edit_room_form.elements['childern'].value);
