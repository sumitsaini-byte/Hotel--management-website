...
<body class="bg-light">
    ...
    $childern_default = $frm_data['childern'];
    }
    ?>
                            ...
                            <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                ...
                                <?php 
                                    ...
                                    while($row = mysqli_fetch_assoc($facilities_q))
                                    {
                                        echo<<<facilities
                                            <div class="mb-2">
                                                <input type="checkbox" onclick="fetch_rooms()" name="facilities" value="$row[id]" class="form-ccheck-input shadow-none me-1" id="$row[id]" >
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="1" id="childern" value="<?php echo $childern_default ?>" oninput="guests_filter()" class="form-control shadow-none">
                                    </div>
                                </div>
                            </div>
                        </div>       
    ...
    let childern = document.getElementById('childern');
    ...
    function guests_filter(){
        if(adults.value>0 || childern.value>0){
            fetch_rooms();
